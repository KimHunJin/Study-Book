...
//	console.log(station + " " + name + " " + times[0] + " " + times[1] + " " + mDate);
	
//	var sql = "insert into info values (" + station +", 'fff', '" + times[0] + "', '" + times[1] + "', '" + mDate + "');";

//	console.log(sql);

	var s = "(" + station + ", 'bus', '" + times[0] + "', '" + times[1] + "', '" + mDate + "')";
	console.log(s);

	infos.push(s);
//	infos.push( "(" + station + ", 'bus', '" + times[0] + "', '" + times[1] + "', '" + mDate + "')");
